    ...
    <>
      <div className="w-screen min-h-screen  relative bg-gradient-to-bl overflow-hidden  from-[#430123] to-[#5A0132]">
        ...
        <div className="flex justify-center  items-center lg:flex-row  flex-col lg:space-y-0 lg:space-x-4 space-y-6 mt-8">
          <Link href={`/PreviousOrders?id=${id}&table=${table_number}&name=${name}`}  className="border-2 poppins-semibold text-center w-40 z-50 border-[#FFF9EA] bg-[#440129] px-4 rounded-full text-[#FFF9EA] py-3">
            Previous Orders
          </Link>
